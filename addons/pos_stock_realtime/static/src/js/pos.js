    ...
    models.PosModel = PosModel.extend({
        ...
        initialize: function (session, attributes) {
            ...
            this.chrome.ready.then(function () {
                self.chrome.call('bus_service', 'onNotification', self, self._onNotification);
                self.chrome.call('bus_service', 'startPolling');
                self.chrome.call('bus_service', '_startElection');
                self.chrome.call('bus_service', 'startPolling');
            })
