...
class ResCompany(models.Model):
    ...
    order_product_detail_in_message = fields.Boolean("Order Product details in message?",default=True)
    ...
    purchase_product_detail_in_message = fields.Boolean("Order Product details in message?",default=True)
    ...
    invoice_product_detail_in_message = fields.Boolean("Order Product details in message?",default=True)
...
class ResConfigSettings(models.TransientModel):
    ...
    order_product_detail_in_message = fields.Boolean(related="company_id.order_product_detail_in_message", string="Order Product details in message?",readonly=False)
    ...
    purchase_product_detail_in_message = fields.Boolean(related="company_id.purchase_product_detail_in_message", string="Order Product details in message?",readonly=False)
    ...
    invoice_product_detail_in_message = fields.Boolean(related="company_id.invoice_product_detail_in_message", string="Order Product details in message?",readonly=False)
