...
class TemplateActivosNoCorrientesLine(models.Model):
	_name = 'template.activos.no.corrientes.line'
	_description = "Plantilla de Configuración de Activos No Corrientes"
	...
	sub_grupo_elemento = fields.Selection(selection=agbr.array_element_sub_groups,default='activo_no_corriente')