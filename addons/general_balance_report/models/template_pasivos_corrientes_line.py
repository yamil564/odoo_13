...
class TemplatePasivosCorrientesLine(models.Model):
	_name = 'template.pasivos.corrientes.line'
	_description = "Plantilla de Configuración de Pasivos Corrientes"
	...
	sub_grupo_elemento = fields.Selection(selection=agbr.array_element_sub_groups,default='pasivo_corriente')